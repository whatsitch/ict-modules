...
namespace ADODisconnectedSample12 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("NWDataSet2")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class NWDataSet2 : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected NWDataSet2(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            NWDataSet2 cln = ((NWDataSet2)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "NWDataSet2";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/NWDataSet2.xsd";
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, int SupplierID, int CategoryID, string QuantityPerUnit, decimal UnitPrice, short UnitsInStock, short UnitsOnOrder, short ReorderLevel, bool Discontinued, string Expr2) {
            ...
            public int SupplierID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte SupplierID in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
            ...
            public int CategoryID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte CategoryID in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
            ...
            public string QuantityPerUnit {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte QuantityPerUnit in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
            ...
            public decimal UnitPrice {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte UnitPrice in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
            ...
            public short UnitsInStock {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte UnitsInStock in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
            ...
            public short UnitsOnOrder {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte UnitsOnOrder in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
            ...
            public short ReorderLevel {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte ReorderLevel in Tabelle Products ist DBNull.", e);
                    }
                }
                set {
...
namespace ADODisconnectedSample12.NWDataSet2TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Products] ([ProductName], [SupplierID], [CategoryID], [QuantityPerUnit], [UnitPrice], [UnitsInStock], [UnitsOnOrder], [ReorderLevel], [Discontinued], [ProductName]) VALUES (@ProductName, @SupplierID, @CategoryID, @QuantityPerUnit, @UnitPrice, @UnitsInStock, @UnitsOnOrder, @ReorderLevel, @Discontinued, @Expr2);
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, ProductID AS Expr1, ProductName AS Expr2 FROM Products WHERE (ProductID = SCOPE_IDENTITY()) AND (ProductID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Products] SET [ProductName] = @ProductName, [SupplierID] = @SupplierID, [" +
                "CategoryID] = @CategoryID, [QuantityPerUnit] = @QuantityPerUnit, [UnitPrice] = @" +
                "UnitPrice, [UnitsInStock] = @UnitsInStock, [UnitsOnOrder] = @UnitsOnOrder, [Reor" +
                "derLevel] = @ReorderLevel, [Discontinued] = @Discontinued, [ProductName] = @Expr" +
                "2 WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_Prod" +
                "uctName) AND ((@IsNull_SupplierID = 1 AND [SupplierID] IS NULL) OR ([SupplierID]" +
                " = @Original_SupplierID)) AND ((@IsNull_CategoryID = 1 AND [CategoryID] IS NULL)" +
                " OR ([CategoryID] = @Original_CategoryID)) AND ((@IsNull_QuantityPerUnit = 1 AND" +
                " [QuantityPerUnit] IS NULL) OR ([QuantityPerUnit] = @Original_QuantityPerUnit)) " +
                "AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original" +
                "_UnitPrice)) AND ((@IsNull_UnitsInStock = 1 AND [UnitsInStock] IS NULL) OR ([Uni" +
                "tsInStock] = @Original_UnitsInStock)) AND ((@IsNull_UnitsOnOrder = 1 AND [UnitsO" +
                "nOrder] IS NULL) OR ([UnitsOnOrder] = @Original_UnitsOnOrder)) AND ((@IsNull_Reo" +
                "rderLevel = 1 AND [ReorderLevel] IS NULL) OR ([ReorderLevel] = @Original_Reorder" +
                "Level)) AND ([Discontinued] = @Original_Discontinued) AND ([ProductID] = @Origin" +
                "al_Expr1) AND ([ProductName] = @Original_Expr2));\r\nSELECT ProductID, ProductName" +
                ", SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder" +
                ", ReorderLevel, Discontinued, ProductID AS Expr1, ProductName AS Expr2 FROM Prod" +
                "ucts WHERE (ProductID = @ProductID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADODisconnectedSample12.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Products.*, ProductID AS Expr1, ProductName AS Expr2\r\nFROM         " +
                "   Products";
        ...
        public virtual int Fill(NWDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual NWDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NWDataSet2.ProductsDataTable dataTable = new NWDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NWDataSet2.ProductsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NWDataSet2 dataSet) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, global::System.Nullable<int> Original_SupplierID, global::System.Nullable<int> Original_CategoryID, string Original_QuantityPerUnit, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock, global::System.Nullable<short> Original_UnitsOnOrder, global::System.Nullable<short> Original_ReorderLevel, bool Original_Discontinued, int Original_Expr1, string Original_Expr2) {
            ...
            this.Adapter.DeleteCommand.Parameters[17].Value = ((int)(Original_Expr1));
        ...
        public virtual int Insert(string ProductName, global::System.Nullable<int> SupplierID, global::System.Nullable<int> CategoryID, string QuantityPerUnit, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, global::System.Nullable<short> UnitsOnOrder, global::System.Nullable<short> ReorderLevel, bool Discontinued, string Expr2) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(
            ...
            if ((Expr2 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Expr2));
            }
            ...
            this.Adapter.UpdateCommand.Parameters[27].Value = ((int)(Original_Expr1));
            if ((Original_Expr2 == null)) {
                throw new global::System.ArgumentNullException("Original_Expr2");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    int Original_Expr1, 
                    string Original_Expr2) {
            return this.Update(ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, Expr2, Original_ProductID, Original_ProductName, Original_SupplierID, Original_CategoryID, Original_QuantityPerUnit, Original_UnitPrice, Original_UnitsInStock, Original_UnitsOnOrder, Original_ReorderLevel, Original_Discontinued, Original_Expr1, Original_Expr2, Original_ProductID);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(NWDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._productsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(NWDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._productsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(NWDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._productsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(NWDataSet2 dataSet) {
            if ((dataSet == null)) {
